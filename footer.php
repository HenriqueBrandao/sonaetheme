...
<footer  data-midnight="dark">
	<div class="container-fluid">
		<div class="row d-flex justify-content-between width100">
			<!-- Copyright -->
			<div class="col-md-6 mt-3 mb-4 d-flex justify-content-center justify-content-md-start ">
				...
				<a target="_blank" href="https://twitter.com/SONAE">
			...
			<div class="col-sm-6 col-md-4 mt-3 mb-4 d-flex justify-content-center justify-content-md-end">
				<a href="<?php the_field('contact_url', 'option'); ?>"><?php the_field('contact', 'option'); ?></a>
				<a href="<?php the_field('privacy_policy_url', 'option'); ?>"><?php the_field('privacy_policy', 'option'); ?></a>
				<a href="<?php the_field('cookies_policy_url', 'option'); ?>"><?php the_field('cookies_policy', 'option'); ?></a>
